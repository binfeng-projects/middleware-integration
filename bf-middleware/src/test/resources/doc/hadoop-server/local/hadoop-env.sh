...
export HDFS_NAMENODE_USER=bf
export HDFS_DATANODE_USER=bf
export HDFS_SECONDARYNAMENODE_USER=bf

export YARN_RESOURCEMANAGER_USER=bf
export YARN_NODEMANAGER_USER=bf
